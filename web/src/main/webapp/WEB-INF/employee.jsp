...
<html>
	...
	<body id="page-top">
		...
		<!-- HEADER -->
		<section class="header hris-section" style="background-image : url('images/employee-bg.jpg')">
			<div class="container">
				<div class="row">
					<h2 class="text-left" style="margin-top:0px; color:black;">Welcome {Employee name here !}</h2> 
				</div>
			</div>
		</section>
		<!-- BULLETIN-->
